...
import { UserOrganizationUserIdOrganizationIdCompoundUniqueInputObjectSchema as UserOrganizationUserIdOrganizationIdCompoundUniqueInputObjectSchema } from './UserOrganizationUserIdOrganizationIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  id: z.number().int().optional(),
  userId_organizationId: z.lazy(() => UserOrganizationUserIdOrganizationIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = ["id"] as string[];
        const groups: string[][] = [["userId","organizationId"]] as string[][];
...
export const UserOrganizationWhereUniqueInputObjectSchema: z.ZodType<Prisma.UserOrganizationWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.UserOrganizationWhereUniqueInput>;
export const UserOrganizationWhereUniqueInputObjectZodSchema = makeSchema();
