...
export const UserOrganizationDeleteOneSchema: z.ZodType<Prisma.UserOrganizationDeleteArgs> = z.object({ select: UserOrganizationSelectObjectSchema.optional(), include: UserOrganizationIncludeObjectSchema.optional(), where: UserOrganizationWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.UserOrganizationDeleteArgs>;

export const UserOrganizationDeleteOneZodSchema = z.object({ select: UserOrganizationSelectObjectSchema.optional(), include: UserOrganizationIncludeObjectSchema.optional(), where: UserOrganizationWhereUniqueInputObjectSchema }).strict();